...
test_that("make_rho returns a 3 x 6 matrix with correct values", {
  ...
  # Use tolerance because 1 - 0.8 has floating-point representation issues
...
test_that("make_rho rejects invalid inputs", {
  # match.arg or stop — just check that an error is thrown
...
test_that("generate_data rejects invalid separation and scenario via match.arg", {
  # match.arg throws an error for unrecognised choices — don't check the message
  # text since it's generated by base R and may vary
